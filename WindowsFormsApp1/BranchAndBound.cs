...
namespace WindowsFormsApp1
{
    ...
    public class BranchAndBoundSimplex
    {
        ...
        public BranchAndBoundSimplex(double[] objectiveCoefficients, double[,] constraintCoefficients,
        ...
        private void SolveRelaxation(Node node)
        {
            ...
            // Perform pivot operations until an optimal solution is found
            int iteration = 0;
            while (true)
            {
                iteration++;
                ...
                output.AppendLine("Updated Tableau:");
                PrintTableau(tableau);
            }
